...
const ItemDetailContainer = () => {
  ...
  const bicicletas = [
    ...
    { id: 2, nombre: 'Racing Bike', descripcion: 'Diseñada para la velocidad en carreteras y competiciones.', precio: 800000, categoria: 'bicimontagne'},
    ...
    mostrarBicicletas
      ...
      const productoFiltrado = bicicletas.find((producto)=> producto.id == id)
